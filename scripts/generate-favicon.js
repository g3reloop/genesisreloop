...
// SVG content for the 4-circle Genesis logo
const svgContent = `<svg width="32" height="32" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
...
console.log('\nTo use it, update your layout.tsx <head> section with:');
